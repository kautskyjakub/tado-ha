...
NUMBERS: tuple[TadoNumberDescription, ...] = (
    ...
    TadoNumberDescription(
        ...
        attr="season_start_month",
        translation_key="season_start_month",
        native_min_value=1,
        native_max_value=12,
        native_step=1,
        mode=NumberMode.BOX,
    ...
    TadoNumberDescription(
        ...
        attr="season_end_month",
        translation_key="season_end_month",
        native_min_value=1,
        native_max_value=12,
        native_step=1,
        mode=NumberMode.BOX,
    ...
    TadoNumberDescription(
        key="frost_protect_temperature",
        attr="frost_protect_temp",
        translation_key="frost_protect_temperature",
        native_min_value=0,
        native_max_value=15,
        native_step=0.5,
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
    ...
    TadoNumberDescription(
        key="mild_outdoor_threshold",
        attr="mild_outdoor_threshold",
        translation_key="mild_outdoor_threshold",
        native_min_value=5,
        native_max_value=25,
        native_step=0.5,
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
